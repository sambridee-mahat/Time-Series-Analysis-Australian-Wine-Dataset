...
All models were estimated via maximum likelihood using the fable package in R.
    ...
    i.   snaive             -                Seasonal Naïve  - (benchmark)
    ii.  ses	          ETS(A,N,N)	         Simple Exponential Smoothing — level only
    iii. holt	          ETS(A,A,N)	         Holt’s Linear — level + trend
    iv.  hw_add	        ETS(A,A,A)	         Holt-Winters Additive seasonality
    v.   hw_mult        ETS(A,A,M)	         Holt-Winters Multiplicative seasonality
    vi.  hw_damped	    ETS(A,Ad,M)	         Holt-Winters Multiplicative + damped trend
...
Key optimized smoothing parameters from the training fit:
    ...
    a.   SES	                  0.588          	—	          —	           —
    b.   Holt	                  0.581	        0.0001	      —	           —
    c.   HW Additive	          0.115	        0.0001	    0.0001	       —
    d.   HW Multiplicative	    0.174	        0.0001	    0.0001	       —
    e.   HW Damped	            0.177	        0.0038	    0.0001	     0.975
...
Lower AICc indicates a better balance of fit versus model complexity:
          ...
          Model	          AIC	        AICc	        BIC
    a.    hw_mult	       2634	        2638	       2687
    b.    hw_damped	     2635	        2640	       2692
    c.    hw_add	       2667	        2671	       2720
    d.    ses	           2882	        2882	       2892
    e.    holt	         2886	        2886	       2902
...
Accuracy evaluated on the held-out 1994 data:
    ...
    a.    hw_mult	      124.0	      293	      238	      9.49%	      1.21
    b.    hw_add	      88.2	      323	      246	      11.5%	      1.25
    c.    hw_damped	    175.0	      302	      258	      10.3%	      1.32
    d.    snaive	      212.0	      403	      332	      13.8%	      1.69
    e.    holt	       -123.0	      592	      395	      22.6%	      2.01
    f.    ses	         -45.0	      603	      423	      23.3%	      2.15
